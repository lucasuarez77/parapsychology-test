...
<head>
<title>Lexscien : Library of Exploratory Science</title>
...
<table class="tborder" width="100%" cellspacing="1" cellpadding="3" align="left">
  <tr class="theader"><td>Our Partners</td></tr>
  ...
  <tr class="trow1" align="center">
   <td>
     <img src="https://github.com/lucasuarez77/parapsychology-test/blob/main/resources/logoSPR.png" vspace="2"> <br>
     <a href="http://www.spr.ac.uk/" class="offsite" target="_blank">Society for Psychical Research</a>
   </td>
  </tr>

  <tr class="trow1" align="center">
   <td>
     <img src="https://github.com/lucasuarez77/parapsychology-test/blob/main/resources/logoRRC.gif" vspace="2"> <br>
     <a href="http://www.rhine.org/" class="offsite" target="_blank">Rhine Research Center</a>
   </td>
  </tr>

  <tr class="trow1" align="center">
    <td>
      <img src="https://github.com/lucasuarez77/parapsychology-test/blob/main/resources/logoSSE.jpg" vspace="2"> <br>
      <a href="http://www.scientificexploration.org/" class="offsite" target="_blank">Society for Scientific Exploration</a>
    </td>
  </tr>

  <tr class="trow1" align="center">
    <td>
      <img src="https://github.com/lucasuarez77/parapsychology-test/blob/main/resources/logoIMI.gif" vspace="2"> <br>
  ...
  <tr class="trow1" align="center">
    <td>
      <img src="https://github.com/lucasuarez77/parapsychology-test/blob/main/resources/logoPA.gif" vspace="2"> <br>
      <a href="http://www.parapsych.org/" class="offsite" target="_blank">Parapsychological Association</a>
    </td>
  </tr>

  <tr class="trow1" align="center">
    <td>
      <img src="https://github.com/lucasuarez77/parapsychology-test/blob/main/resources/logoEHE.gif" vspace="2"> <br>
      <a href="http://www.ehe.org/" class="offsite" target="_blank">Exceptional Human Experiences Network</a>
    </td>
  </tr>

  <tr class="trow1" align="center">
    <td>
      <img src="https://github.com/lucasuarez77/parapsychology-test/blob/main/resources/logoEJP.png" vspace="2"> <br>
      <a href="http://ejp.org.uk/" class="offsite" target="_blank">European Journal of Parapsychology</a>
    </td>
  </tr>
    ...
    <td width="60%" valign="top">
      ...
      <table class="tborder" width="75%" border="2" cellspacing="0" cellpadding="20" align="center" wrap="nowrap">
        <tr class="trowfinal"><td>
          <img src="/lexscien/resources/SPRicon.png" border="0" vspace="3" hspace="3" wrap="soft" align="left" valign="top">
<b>SPR Members:</b> Lexscien holds the SPR's historical
publications alongside the literature of other organizations.  As an SPR
member you have free access to all of the SPR's literature, and discounted
access to all the rest.  To ensure your free SPR access please register with
Lexscien using the same email address that the SPR holds for you - if you have
any difficulties please contact the SPR in the first instance.
      ...
      <tr class="theader"><td>Overview</td></tr>
      <tr class="trow1"><td>
...
<img src="/lexscien/resources/cfar_logo_small.gif" height="42" width="105" border="0" vspace="30" hspace="20"
...
it works <a href="infofeatures.html" class="command">here</a>.
    ...
    <td valign="top">
      ...
      <table class="tborder" width="100%" cellspacing="1" cellpadding="3">
        <tr class="theader"><td>Privacy</td></tr>
        <tr class="trowfinal">
          <td>
...
your personal or financial information.
      ...
      <br clear="all">
      <table class="tborder" width="100%" cellspacing="1" cellpadding="3">
        <tr class="theader"><td>What Others Say</td></tr>
        <tr class="trowfinal">
          <td>
<table width="100%">
...
<tr class="quote"><td align="left">
&ldquo;This is absolutely marvellous. I've just spent a wonderful afternoon browsing through the JSP and EJP...&rdquo;
</td></tr>
